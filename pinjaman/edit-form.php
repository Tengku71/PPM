  ...
  <body style="height: 100vh;">
    ...
    <div class="right-side bg-body-tertiary container-fluid mx-0">
      ...
      <div class="header-right d-flex justify-content-end mb-2">
        ...
        <h3 class="fs-3 ps-4 mt-3">Edit Peminjam</h3>
      <div class="sample-data-siswa bg-body shadow-sm ms-4">
        <p class="fs-5 ps-5 pt-4">Form Edit Peminjam</p>
        <?php
        if ($result) {
      ...
      ?>
        <form class="px-5 pb-3" method="POST" action="update.php">
          ...
          <div class="mb-3">
            <input type="hidden" id="idSiswa" name="idSiswa" value="<?php echo $row["id_siswa"]?>"/>
            <label for="nama" class="form-label">Nama</label>
            <input type="text" class="form-control" id="nama-peminjam" name="nama" value="<?php echo $row["nama"]?>" required>
            <div id="popoverContentSiswa" class="popover-contentSiswa"></div>
          </div>
          <div class="mb-4">
            <input type="hidden" id="idBuku" name="idBuku" value="<?php echo $row["id_buku"]?>"/>
            <label for="judul" class="form-label">Nama Buku</label>
            <input type="text" class="form-control" name="judul" id="nama-buku" value="<?php echo $row["judul"]?>" required>
          ...
          <div class="row mb-4">
            <div class="col">
              ...
              <input type="date" class="form-control" name="tanggal-peminjaman" id="tanggal-peminjaman" name="tanggal-peminjaman" value="<?php echo $row["tanggal_peminjaman"]?>">
            </div>
            <div class="col">
              <label for="tanggal-pengembalian" class="form-label">Tanggal Pengembalian</label>
              <input type="date" class="form-control" name="tanggal-pengembalian" id="tanggal-pengembalian" name="tanggal-pengembalian" value="<?php echo $row["tanggal_pengembalian"]?>">
            </div>
