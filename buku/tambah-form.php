...
<html lang="en">
  ...
  <body style="height: 100vh;">
    ...
    <div class="right-side bg-body-tertiary container-fluid mx-0">
      ...
      <h3 class="fs-3 ps-4">Tambah Buku</h3>
      <div class="sample-data-siswa bg-body shadow-sm ms-4">
        <p class="fs-5 ps-5 pt-2">Form Tambah Buku</p>
        <form class="px-5" method="POST" action="tambah.php" onsubmit="return validateForm()">
          <div class="row mb-2">
            <div class="col">
              <label for="buku_id" class="form-label">Buku ID</label>
              <input type="text" class="form-control" name="buku_id" id="buku_id">
              <span id="buku_id-error" class="text-danger"></span>
            </div>
            <div class="col">
            ...
            <div class="col">
              ...
              <span id="pengarang-error" class="text-danger"></span>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col">
            ...
            <div class="col">
              ...
              <span id="tahun-error" class="text-danger"></span>
            </div>
            <div class="col">
              <label for="jumlah" class="form-label">Jumlah</label>
              <input type="text" class="form-control" name="jumlah" id="jumlah">
              <span id="jumlah-error" class="text-danger"></span>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-4">
            ...
            <div class="col">
              ...
              <span id="rak-error" class="text-danger"></span>
            </div>
            <div class="col">
              <label for="sampul" class="form-label">Sampul</label>
              <input type="text" class="form-control" name="sampul" id="sampul">
              <span id="sampul-error" class="text-danger"></span>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col">
              ...
              <span id="lampiran-error" class="text-danger"></span>
            </div>
            <div class="col">
              <label for="isi" class="form-label">Isi</label>
              <input type="text" class="form-control" name="isi" id="isi">
              <span id="isi-error" class="text-danger"></span>
            </div>
            <div class="col-3">
              <label for="tanggal_masuk" class="form-label">Tanggal Masuk</label>
              <input type="date" class="form-control" name="tanggal_masuk" id="tanggal_masuk">
              <span id="tanggal_masuk-error" class="text-danger"></span>
            </div>            
          </div>
          <a class="btn color-green text-light px-4 my-2 me-4" href="../data-buku.php">Kembali</a>
