  ...
  <body style="height: 100vh;">
      ...
      <div class="d-flex ms-3 pe-3 flex-column border-end border-dark-subtle border-1 justify-content-start h-100 w-25">
        ...
        <div class="navbar d-flex flex-column align-items-start h-75 w-100">
          ...
          <div class="master-data w-100">
            ...
            <!-- Data Buku -->
            <a href="../data-buku.php" class="data-buku-btn btn color-green text-light d-flex align-items-center ">
    ...
    <div class="right-side bg-body-tertiary container-fluid mx-0">
      ...
      <div class="header-right d-flex justify-content-end mb-2">
        ...
        <h3 class="fs-3 ps-4 mt-3">Edit Buku</h3>
      <div class="sample-data-siswa bg-body shadow-sm ms-4">
        <p class="fs-5 ps-5 pt-4">Form Edit Buku</p>
        <?php
        if ($result) {
        ...
        <form class="px-5 pb-3" method="POST" action="update.php">
          ...
          <div class="row mb-2">
            <div class="col">
              ...
              <input type="text" class="form-control" name="buku_id" id="buku_id" value="<?php echo $row["buku_id"]?>" required>
            </div>
            <div class="col">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" name="pengarang" id="pengarang" value="<?php echo $row["pengarang"]?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col">
              <label for="penerbit" class="form-label">Penerbit</label>
              <input type="text" class="form-control" name="penerbit" id="penerbit" value="<?php echo $row["penerbit"]?>" required>
            </div>
            <div class="col">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" name="jumlah" id="jumlah" value="<?php echo $row["jumlah"]?>" required>
            </div>
          </div>
          <div class="row mb-2">
            <div class="col-5">
              <label for="isbn" class="form-label">ISBN</label>
              <input type="text" class="form-control" name="isbn" id="isbn" value="<?php echo $row["isbn"]?>">
            </div>
            <div class="col">
              <label for="kategori" class="form-label">Kategori</label>
              <input type="text" class="form-control" name="kategori" id="kategori" value="<?php echo $row["kategori"]?>" required>
            </div>
            <div class="col">
              <label for="rak" class="form-label">Rak</label>
              <input type="text" class="form-control" name="rak" id="rak" value="<?php echo $row["rak"]?>" required>
            </div>
            <div class="col">
              <label for="sampul" class="form-label">Sampul</label>
              <input type="text" class="form-control" name="sampul" id="sampul" value="<?php echo $row["sampul"]?>">
            </div>
          </div>
          <div class="row mb-2">
            <div class="col">
              <label for="lampiran" class="form-label">Lampiran</label>
              <input type="text" class="form-control" name="lampiran" id="lampiran" value="<?php echo $row["lampiran"]?>">
            </div>
            <div class="col">
            ...
            <div class="col-3">
              ...
              <input type="date" class="form-control" name="tanggal_masuk" id="tanggal_masuk" value="<?php echo $row["tanggal_masuk"]?>">
            </div>            
          </div>
          <a class="btn color-green text-light px-4 my-1 me-4" href="../data-buku.php">Kembali</a>
