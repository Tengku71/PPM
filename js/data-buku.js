    ...
    if (allData.length === 0) {
      ...
      allData.forEach(function (row) {
        ...
        newRow.innerHTML = `
                    ...
                    <a href="buku/edit-form.php?id=${row.id}" class="col btn btn-secondary"><img src="img/icon/pencil.svg" alt=""></a>
                    <button class=" btn btn-danger delete-btn" data-bs-toggle="modal" data-bs-target="#hapus_konfirmasi" data-id="${row.id}"><img src="img/icon/trash.svg" alt=""></button>
                    <a href="buku/tampil.php?id=${row.id}" class="col btn btn-info"><img src="img/icon/eye.svg" alt=""></a>
                </td>
                `;
