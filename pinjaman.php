...
<html lang="en">
  ...
  <body style="height: 100vh;">
        ...
        <div class="navbar d-flex flex-column align-items-start h-75 w-100">
          ...
          <div class="master-data w-100">
            ...
            <a href="data-siswa.php" class="data-siswa-btn btn d-flex align-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-person me-2 data-siswa-svg" viewBox="0 0 16 16">
            ...
            <a href="data-buku.php" class="data-buku-btn btn d-flex align-items-center ">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-journal-text me-2 data-buku-svg" viewBox="0 0 16 16">
    ...
    <div class="right-side bg-body-tertiary container-fluid mx-0">
      ...
      <h3 class="fs-3 ps-4 mt-3">Pinjaman</h3>
      <div class="sample-data-siswa bg-body shadow-sm ms-4">
        <p class="fs-5 ps-5 pt-4">Form Peminjaman</p>
        <form class="px-5 pb-3" method="POST" action="pinjaman/tambah.php" onsubmit="return validateForm()">
          <div class="mb-3">
            <input type="hidden" id="idSiswa" name="idSiswa"/>
            <label for="nama-peminjam" class="form-label">Nama Peminjam</label>
            <input type="text" class="form-control" id="nama-peminjam">
            <span id="nama-peminjam-error" class="text-danger"></span>
            <div id="popoverContentSiswa" class="popover-contentSiswa"></div>
          </div>
          <div class="mb-3">
            ...
            <span id="nama-buku-error" class="text-danger"></span>
            <div id="popoverContentBuku" class="popover-contentBuku"></div>
          </div>
          <div class="row mb-3">
            <div class="col">
              <label for="tanggal-peminjaman" class="form-label">Tanggal Peminjaman</label>
              <input type="date" class="form-control" id="tanggal-peminjaman" name="tanggal-peminjaman">
              <span id="tanggal-peminjaman-error" class="text-danger"></span>
            </div>
            <div class="col">
              ...
              <div id="tanggalHelp" class="form-text">7 hari setelah tanggal peminjaman</div>
